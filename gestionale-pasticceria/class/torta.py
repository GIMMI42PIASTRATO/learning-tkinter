...
class Torta(Dolce):
    ...
    def __init__(self, nome: str, desc: str, peso: float, prezzo: float, ingredienti: list[str], temp_conservazione: float) -> None:
...
test = Torta("Torta di bonemeel", "Classica torta di minecraft", 40.5, 5.5, ["uova", "zucchero", "bonemeel", "uvetta"], 5.5)
