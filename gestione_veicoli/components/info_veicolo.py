...
class InfoVeicolo(CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.info_prezzo = CTkLabel(self, text="")
    ...
    def display_info(self, veicolo):
        ...
        self.info_prezzo.grid(row=1, column=2, sticky="w", padx=10, pady=10)
        self.info_variable.grid(row=2, column=0, sticky="w", padx=10, pady=10)
        self.info_targa.grid(row=2, column=1, sticky="w", padx=10, pady=10)

        # Set the text of the labels
        if veicolo.get_tipo() == "Autoveicolo":
            text = ["Numero porte:", veicolo.get_numero_porte, ""]
        elif veicolo.get_tipo() == "Autocarro":
            text = ["Carico massimo:", veicolo.get_max_carico, "q"]
        else:
            text = ["Cilindrata:", veicolo.get_cilindrata, "cc"]
    ...
    def remove_info(self):
        self.info_marca.configure(text="")
        self.info_modello.configure(text="")
        self.info_tipo_veicolo.configure(text="")
        self.info_numero_posti.configure(text="")
        self.info_prezzo_base.configure(text="")
        self.info_prezzo.configure(text="")
        self.info_variable.configure(text="")
        self.info_targa.configure(text="")
